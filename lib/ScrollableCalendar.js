...
var getWeekDays = function getWeekDays(startDate, daysInWeek) {
  var week = [];
...
var ScrollableCalendar = function ScrollableCalendar(_ref) {
  var onDateSelect = _ref.onDateSelect,
    ...
    _ref$daysInWeek = _ref.daysInWeek,
    daysInWeek = _ref$daysInWeek === void 0 ? 7 : _ref$daysInWeek,
    _ref$canSelectPastDat = _ref.canSelectPastDates,
    canSelectPastDates = _ref$canSelectPastDat === void 0 ? false : _ref$canSelectPastDat,
  ...
  var currentWeekDays = getWeekDays(currentWeekStart, daysInWeek);
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      className: "day ".concat(!canSelectPastDates && day.isBefore(today, "day") ? "disabled" : "", " ").concat(selectedDate !== null && selectedDate !== void 0 && selectedDate.isSame(day, "day") ? "selected" : ""),
...
ScrollableCalendar.propTypes = {
  ...
  daysInWeek: _propTypes["default"].number,
  // New prop for setting number of days
  canSelectPastDates: _propTypes["default"].bool // New prop for allowing/disallowing past dates
};
